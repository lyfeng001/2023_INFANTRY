...
//static void buzzer_warn_error(uint8_t num);   //注释掉因为：declared but never referenced
...
{
    //static uint8_t error, last_error;  //注释掉因为：declared but never referenced
    //static uint8_t error_num;         //注释掉因为：declared but never referenced
...
/**
  ...
  * @retval         none
  */
//static void buzzer_warn_error(uint8_t num)       //注掉因为：warning:declared but never referenced
//{
